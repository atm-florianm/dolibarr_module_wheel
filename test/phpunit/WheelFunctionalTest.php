...
/**
 * \file    test/phpunit/WheelFunctionalTest.php
 * \ingroup wheel
 ...
 * @package Testwheel
 */
class WheelFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/wheel/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('wheel/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/wheel/admin/about.php');
		$this->authenticate();
		return $this->assertContains('wheel/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('wheelwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWheel_WheelTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWheel_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
